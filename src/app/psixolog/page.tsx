...
export default function Psixolog() {
	...
	return (
		<div className="container !py-10 grid md:grid-cols-3 gap-20">
			{/* Chap qism */}
			...
			<div className="md:col-span-2 space-y-6">
				<section className="bg-white border border-gray-200 rounded-2xl p-10">
					<h3 className="text-2xl font-medium mb-4">ОБО МНЕ</h3>
					<div className="p-4 bg-[#FCF9FF] text-xl rounded-4xl rounded-tl-md text-[#001E24]">
					...
					<section className="mt-6">
						...
						<ul className="space-y-3">
							<li className="flex p-6 rounded-3xl bg-[#F7F9FC] items-center gap-5">
				...
				<section className="space-y-8">
					<h2 className="text-3xl font-medium">ПРЕДОСТАВЛЯЕМЫЕ УСЛУГИ:</h2>

					{/* 1 - Психологическая помощь взрослым и детям */}
					<div>
						<h3 className="flex items-center gap-2 text-2xl text-purple-600 font-medium">
						...
						<div className="bg-purple-50 rounded-tl-md rounded-4xl p-4 mt-2 space-y-2 text-gray-700">
							<ul className="list-none list-inside space-y-2">
								<li className="flex gap-5 items-center text-xl">
									<div className="h-[1px] w-4 border-b border-purple-600 "></div>{" "}
					...
					<div>
						<h3 className="flex  gap-2 text-primary-dark text-2xl font-medium">
						...
						<div className="bg-cyan-50 rounded-tl-md rounded-4xl p-4 mt-2 space-y-2 text-gray-700">
							<ul className="list-inside space-y-2 text-xl">
								<li className="flex gap-5 items-start text-xl">
									<div className="h-[1px] w-4 border-b mt-3.5 border-primary-dark "></div>{" "}
								...
								<li className="flex gap-5 items-center text-xl">
									<div className="h-[1px] w-4 border-b border-primary-dark "></div>{" "}
						...
						<div className="bg-purple-50 rounded-tl-md rounded-4xl p-4 mt-2 space-y-2 text-gray-700">
							<ul className="list-none list-inside space-y-2">
								...
								<li className="flex gap-5  text-xl">
									<div className="h-[1px] w-4 mt-3.5 border-b border-purple-600 "></div>{" "}
